...
class DynamoUOW(UOW):
    ...
    def transaction(self) -> Generator[Any, None, None]:
        raise NotImplementedError("Details to implement: https://aws.amazon.com/blogs/aws/new-amazon-dynamodb-transactions/")
    ...
    def example(self) -> ExampleRepository:
        return ExampleRepository(self.resource, table="example", required_filters=self._required_filters)
