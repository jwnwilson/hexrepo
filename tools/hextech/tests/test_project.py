...
# def test_bake_project(cookies, update_path_project):
...
# def test_bake_then_run_project_tests(cookies, update_path_project):
#     """Test for 'cookiecutter-template'."""
#     result = cookies.bake(template="../../templates/project", extra_context={"project_name": "test_project"})
...
# def test_project_nosql(cookies, update_path_project):
#     """Test for 'cookiecutter-template'."""
...
# def test_project_no_db(cookies, update_path_project):
#     """Test for 'cookiecutter-template'."""
...
# def test_project_no_api(cookies, update_path_project):
#     """Test for 'cookiecutter-template'."""
