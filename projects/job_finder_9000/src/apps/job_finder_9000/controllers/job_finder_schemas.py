...
class LocationSchema(Schema):
    ...
    def validate_remote_preference(cls, v):
        ...
        if v.lower() not in valid_preferences:
            raise ValueError(f'Remote preference must be one of: {", ".join(valid_preferences)}')
        return v.lower()
...
class MarketAnalysisSchema(Schema):
    ...
    market_demand: str = Field(..., description="Market demand level: low, medium, high")
...
class JobRecommendationsSchema(Schema):
    ...
    recommendations: List[JobPostingSchema] = Field(..., description="Recommended job postings")
    total_recommendations: int = Field(..., description="Total number of recommendations")
    average_match_score: float = Field(..., description="Average match score of recommendations")
...
class JobSearchSuccessSchema(Schema):
    ...
    success: bool = Field(True, description="Success indicator")
    message: str = Field("Job search completed successfully", description="Success message")
...
class RecommendationsSuccessSchema(Schema):
    ...
    success: bool = Field(True, description="Success indicator")
    message: str = Field("Job recommendations generated successfully", description="Success message")
...
class MarketAnalysisSuccessSchema(Schema):
    ...
    success: bool = Field(True, description="Success indicator")
    message: str = Field("Market analysis completed successfully", description="Success message")
...
class CacheClearSchema(Schema):
    ...
    cleared_entries: Optional[int] = Field(None, description="Number of cache entries cleared") 