...
class SkillMatcherAgent(Agent):
    ...
    def _register_tools(self):
        ...
        @self.tool_plain
        def calculate_skill_match_score(candidate_skills: List[Skill], job_requirements: List[JobRequirement]) -> float:
            """
...
class JobScraperAgent(Agent):
    ...
    def _register_tools(self):
        """Register tools with the agent."""
        @self.tool_plain
        async def scrape_linkedin_jobs(keywords: List[str], location: str, max_results: int = 20) -> List[Dict[str, Any]]:
            """
        ...
        @self.tool_plain
        async def scrape_indeed_jobs(keywords: List[str], location: str, max_results: int = 20) -> List[Dict[str, Any]]:
            """
        ...
        @self.tool_plain
        async def scrape_glassdoor_jobs(keywords: List[str], location: str, max_results: int = 20) -> List[Dict[str, Any]]:
            """
...
class SalaryAnalyzerAgent(Agent):
    ...
    def _register_tools(self):
        """Register tools with the agent."""
        @self.tool_plain
        def analyze_salary_market_rate(job_title: str, location: str, experience_years: int) -> Dict[str, Any]:
            """
        ...
        @self.tool_plain
        def calculate_salary_score(job_salary: int, market_rate: int, candidate_expectation: Optional[int] = None) -> float:
            """
...
class LocationAnalyzerAgent(Agent):
    ...
    def _register_tools(self):
        """Register tools with the agent."""
        @self.tool_plain
        def analyze_location_preferences(candidate_locations: List[Location], job_location: str) -> float:
            """
...
class JobFinderOrchestratorAgent(Agent):
    ...
    def _register_tools(self):
        """Register tools with the agent."""
        @self.tool_plain
        async def find_jobs(request: JobSearchRequest) -> JobSearchResult:
            """
