...
locals {
  db_url = "postgresql+psycopg://postgres:{password}@${module.aipet_be_postgres.db_instance_endpoint}/${var.project}"
  db_ro_url = module.aipet_be_postgres.db_instance_ro_endpoint != null ? "postgresql+psycopg://postgres:{password}@${module.aipet_be_postgres.db_instance_ro_endpoint}/${var.project}" : "postgresql+psycopg://postgres:{password}@${module.aipet_be_postgres.db_instance_endpoint}/${var.project}"
}
...
module "aipet_be_api_gateway" {
  ...
  environment       = terraform.workspace
  lambda_invoke_arn = module.aipet_be_api.lambda_function_invoke_arn
  lambda_name       = module.aipet_be_api.lambda_function_name
  domain            = var.domain
  api_subdomain     = "aipet_be-${terraform.workspace}"
  project           = "aipet_be"
