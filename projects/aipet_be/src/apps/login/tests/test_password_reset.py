...
class TestPasswordResetEndpoints:
    ...
    def test_request_password_reset_invalidates_existing_tokens(self, api_client, user_factory):
    ...
    def test_confirm_password_reset_invalidates_other_tokens(self, api_client, user_factory):
