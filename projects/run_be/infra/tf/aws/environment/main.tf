...
locals {
  ...
  db_ro_url = module.run_be_postgres.db_instance_ro_endpoint != null ? "postgresql+psycopg://postgres:{password}@${module.run_be_postgres.db_instance_ro_endpoint}/${var.project}" : "postgresql+psycopg://postgres:{password}@${module.run_be_postgres.db_instance_endpoint}/${var.project}"
}
