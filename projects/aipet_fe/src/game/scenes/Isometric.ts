...
export class Isometric extends Scene
{
    controls;
    ...
    preload ()
    {
        ...
        this.load.image('tiles', 'https://labs.phaser.io/assets/tilemaps/iso/iso-64x64-outside.png');
        this.load.image('tiles2', 'https://labs.phaser.io/assets/tilemaps/iso/iso-64x64-building.png');
